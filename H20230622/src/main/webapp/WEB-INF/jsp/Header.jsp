...
<html lang="en">
    <head>
        ...
        <link href="bootstrap/bootstrap/css/styles.css" rel="stylesheet" />
    </head>
    <body>
    	<%
        ...
        <div class="d-flex" id="wrapper">
            ...
            %>
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="memberInfo.do">내정보</a>
                    <%
                    }
                    %>
